        ...
        <div class="profile-intake-main join-modal-body profile-template-body">
          <div class="profile-intake-list">
            ...
            <section class="profile-intake-question" data-step="1">
              ...
              <p class="profile-intake-qtitle">妳/你目前的主修科系背景大約屬於哪一類？</p>
            ...
            <section class="profile-intake-question" data-step="2">
              ...
              <div class="profile-intake-options cols-2" id="participant-profile-disposable-row">
                <label class="profile-option-card"><input type="radio" name="participant-profile-disposable" value="NT$ 20,000 元以下"><span class="profile-option-check">✓</span><span class="profile-option-text">NT$ 20,000 元以下</span></label>
                <label class="profile-option-card"><input type="radio" name="participant-profile-disposable" value="NT$ 20,001 ~ NT$ 35,000 元"><span class="profile-option-check">✓</span><span class="profile-option-text">NT$ 20,001 ~ NT$ 35,000 元</span></label>
                <label class="profile-option-card"><input type="radio" name="participant-profile-disposable" value="NT$ 35,001 ~ NT$ 70,000 元"><span class="profile-option-check">✓</span><span class="profile-option-text">NT$ 35,001 ~ NT$ 70,000 元</span></label>
                <label class="profile-option-card"><input type="radio" name="participant-profile-disposable" value="NT$ 70,001 元以上"><span class="profile-option-check">✓</span><span class="profile-option-text">NT$ 70,001 元以上</span></label>
              </div>
            </section>
            ...
            <section class="profile-intake-question" data-step="3">
              ...
              <div class="profile-intake-options cols-2" id="participant-profile-household-row">
                <label class="profile-option-card"><input type="radio" name="participant-profile-household" value="日常受薪家庭"><span class="profile-option-check">✓</span><span class="profile-option-text">日常受薪家庭（年所得 NT$ 45 萬元以下）</span></label>
                <label class="profile-option-card"><input type="radio" name="participant-profile-household" value="標準小資家庭"><span class="profile-option-check">✓</span><span class="profile-option-text">標準小資家庭（年所得 NT$ 45 萬 ~ NT$ 100 萬元）</span></label>
                <label class="profile-option-card"><input type="radio" name="participant-profile-household" value="穩健中產家庭"><span class="profile-option-check">✓</span><span class="profile-option-text">穩健中產家庭（年所得 NT$ 100 萬 ~ NT$ 180 萬元）</span></label>
                <label class="profile-option-card"><input type="radio" name="participant-profile-household" value="優渥富裕家庭"><span class="profile-option-check">✓</span><span class="profile-option-text">優渥富裕家庭（年所得 NT$ 180 萬元以上）</span></label>
              </div>
            </section>
          </div>
